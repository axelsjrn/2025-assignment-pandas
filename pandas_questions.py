...
path = '/Users/axel/Desktop/Cours 25:26/data camp' \
...
def merge_referendum_and_areas(referendum, regions_and_departments):
    ...
    ref['bool'] = ref['Department code'].apply(lambda x: 1 if 'Z' in x else 0)
    ref = ref[ref['bool'] == 0].drop('bool', axis=1)
    ref['Department code'] = ref['Department code'].astype('str')
    ref['Department code'] = ref['Department code'].apply(lambda x: '0' + x if len(x) == 1 else x)

    return reg_and_dep.merge(ref, left_on='code_dep', right_on='Department code', how='right')
...
def compute_referendum_result_by_regions(referendum_and_areas):
    ...
    """
    result = (
        referendum_and_areas[['code_reg', 'name_reg', 'Registered',
...
def plot_referendum_map(referendum_result_by_regions):
    ...
    * Return a gpd.GeoDataFrame with a column 'ratio' containing the results.
    ...
    gdf = gdf_regions.merge(results, left_on="code", right_on='code_reg', how="left")
